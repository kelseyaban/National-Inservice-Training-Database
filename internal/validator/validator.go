...
// All validation errors go into this one Validtor instance
func New() *Validator {
	return &Validator{
...
// Checking if the Validator's map contains any entries
...
// If any validation check returns false, then make an entry into our validator's error map
